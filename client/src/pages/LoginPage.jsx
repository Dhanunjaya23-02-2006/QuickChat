  ...
  return (
    ...
    justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl">
        ...
        flex flex-col gap-6 rounded-lg shadow-lg'>
          <h2 className='font-medium flex text-2xl justify-between item-center '>
            {currState}
            {isDataSubmitted && <img onClick={()=>{
              setIsDataSubmitted(false)
            }} src={assets.arrow_icon} alt="" className='w-5 
            cursor-pointer' />
            }
          </h2>
          ...
          {currState === "Sign up" && isDataSubmitted && (
              <textarea onChange={(e)=> setBio(e.target.value)} value={bio} rows={3} className='p-2 border border-gray-500 rounded-md
